        ...
        <div class="alert bg-orange-transparent alert-dismissible fade show mb-4">
            <div>
                <span><i class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product </span> <span
                    class="text-orange fw-semibold"> Apple Iphone 15 is running Low, </span> already below 5 Pcs., <a
                    href="javascript:void(0);" class="link-orange text-decoration-underline fw-semibold"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="border p-2 br-8">
                                    <p class="d-inline-flex align-items-center mb-1"><i
                                            class="ti ti-circle-filled fs-8 text-primary-300 me-1"></i>Total Purchase</p>
                                    <h4>3K</h4>
                                </div>
                                <div class="border p-2 br-8">
                                    <p class="d-inline-flex align-items-center mb-1"><i
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body sell-product">
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-01.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-16.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-03.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-04.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-05.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-06.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-07.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-08.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-09.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-0">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-10.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-11.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-12.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-13.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-14.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-0">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="backend/assets/img/products/product-15.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="backend/assets/img/customer/customer16.jpg"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="backend/assets/img/customer/customer17.jpg"
                                                                class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="backend/assets/img/customer/customer18.jpg"
                                                                class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="backend/assets/img/customer/customer15.jpg"
                                                                class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="backend/assets/img/customer/customer13.jpg"
                                                                class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                                    <img src="backend/assets/img/customer/customer11.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                                    <img src="backend/assets/img/customer/customer12.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                                    <img src="backend/assets/img/customer/customer13.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                                    <img src="backend/assets/img/customer/customer14.jpg" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
                                    <img src="backend/assets/img/customer/customer15.jpg" alt="img">
                                </a>
                                <div class="ms-2">
